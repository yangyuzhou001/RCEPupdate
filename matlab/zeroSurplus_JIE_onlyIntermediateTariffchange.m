...
% mu = -xlsread('..\data\theta-mu.xlsx','C1:C17');
% cp = ones(N,N,J);
...
kappa_m_hat_rcep=tau_rcep_mtariff./tau;                                           % Change in trade cost
kappa_f_hat_rcep=tau_rcep_ftariff./tau;
...
save ..\data\rcep_JIE_onlyIntermediateTariffchange.mat wf0_rcep pf_rcep pm_rcep Xj_m_np_rcep Xj_f_np_rcep ...
...
save ..\data\tau_JIE_onlyIntermediateTariffchange.mat taup tau_mp tau_fp tau ...
