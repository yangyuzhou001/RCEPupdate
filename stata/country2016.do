import excel using ".\originaldata\SNA93\ReadMe_CSV.xlsx", sheet("CtryInd") cellrange(B4:E39) clear
...
replace name = "卢森堡" if countryid == 21
replace name = "墨西哥" if countryid == 22
replace name = "荷兰" if countryid == 23
replace name = "新西兰" if countryid == 24
replace name = "挪威" if countryid == 25
replace name = "波兰" if countryid == 26
replace name = "葡萄牙" if countryid == 27
replace name = "斯洛伐克" if countryid == 28
replace name = "斯洛文尼亚" if countryid == 29
replace name = "西班牙" if countryid == 30
replace name = "瑞典" if countryid == 31
replace name = "瑞士" if countryid == 32
replace name = "土耳其" if countryid == 33
replace name = "英国" if countryid == 34
replace name = "美国" if countryid == 35
replace name = "阿根廷" if countryid == 36
replace name = "巴西" if countryid == 37
replace name = "文莱" if countryid == 38
replace name = "保加利亚" if countryid == 39
replace name = "柬埔寨" if countryid == 40
replace name = "中国" if countryid == 41
replace name = "中国台湾" if countryid == 42
...
replace name = "中国香港" if countryid == 47
replace name = "印度" if countryid == 48
replace name = "印度尼西亚" if countryid == 49
//replace name = "中国香港" if countryid == 49
replace name = "立陶宛" if countryid == 50
//replace name = "哈萨克斯坦" if countryid == 51
...
//replace name = "中国台湾" if countryid == 60
replace name = "泰国" if countryid == 61
replace name = "突尼斯" if countryid == 62
replace name = "越南" if countryid == 63
replace name = "其他国家地区" if countryid == 64
...
save ".\data\countryname2016.dta", replace
